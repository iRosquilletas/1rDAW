...
public class Main {
    public static void main(String[] args) {
        ...
        gestorHeroes.agregarHeroe(new Heroe("Iron Man", "Traje de alta tecnología", "Millonario y filántropo", "es un superheroe de metal"));
        gestorHeroes.agregarHeroe(new Heroe("Spider-Man", "Sentido arácnido, trepador", "Tímido estudiante de secundaria", "es un superheroe que tiene teladearaña"));
        gestorHeroes.agregarHeroe(new Heroe("Capitán América", "Superfuerza, agilidad, resistencia", "Soldado de la Segunda Guerra Mundial","Es un Heroe que desataca por su escudo" ));
